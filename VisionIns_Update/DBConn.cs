...
namespace VisionIns_Update
{
    public static class DBConn
    {
        ...
        public static string sqlConnection = "server = 121.66.17.30,16433; uid = pineit; pwd = pineit0401; database = VISION_INS";
        ...
        public static SqlConnection DbConn()
        {
            ...
            try
            {
                ...
                sqlConnection = string.Format("server = 121.66.17.30,16433; uid = pineit; pwd = pineit0401; database = {0}", "VISION_INS");
